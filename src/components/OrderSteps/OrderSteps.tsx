  ...
  return (
    <>
      <div className="bg-white rounded-2xl px-4 py-6 text-xs md:p-6 md:text-lg">
        <div className="mb-6">
          <div className="text-lg font-extrabold">Ongoing Order Progress</div>
          {status == "cancelled" && <div className="text-xs text-red-500">Order Cancelled</div>}
        </div>

        {/* step start */}
        <div className="flex items-center gap-8">
          <div
            className={`p-4 border-2 w-max rounded-full opacity-50 border-gray-500 ${
              status == "ordered" ||
              status == "cooking" ||
              status == "picked" ||
              status == "ontheway" ||
        ...
        <div
          className={`  border-l-2 h-10 w-0 ml-6.5  border-gray-500 opacity-50 ${
            status == "cooking" ||
            status == "picked" ||
            status == "ontheway" ||
            status == "delivered"
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="w-full flex justify-between">
            <div>
              ...
              <div className="text-xs text-gray-500">cooking your food</div>
            </div>
        ...
        <div
          className={`  border-l-2 h-10 w-0 ml-6.5  border-gray-500 opacity-50 ${
            status == "picked" || status == "ontheway" || status == "delivered"
              ? "border-green-600"
              : ""
          }`}
        ></div>
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="w-full flex justify-between">
            <div>
              ...
              <div className="text-xs text-gray-500">picked your order</div>
            </div>
        ...
        <div
          className={`  border-l-2 h-10 w-0 ml-6.5  border-gray-500 opacity-50 ${
            status == "ontheway" || status == "delivered"
              ? "border-green-600"
              : ""
          }`}
        ></div>
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="w-full flex justify-between">
            <div>
              ...
              <div className="text-xs text-gray-500">food is on the way</div>
            </div>
        ...
        <div
          className={`  border-l-2 h-10 w-0 ml-6.5  border-gray-500 opacity-50 ${
            status == "delivered" ? "border-green-600" : ""
          }`}
        ></div>
        {/* step end */}
